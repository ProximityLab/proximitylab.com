<div id="carouselHome" class="carousel slide" data-ride="carousel">
  ...
  <a href="/"><img id="pl-logo-hero" class="pl-logo-hero" src="images/logo-proximity-lab-white.svg" alt="Proximity Lab logo"></a>

  <div class="carousel-inner" role="listbox">
    <div class="carousel-item carousel-item1 active">
      <div class="carousel-caption d-none d-md-block">
        <p class="carousel-text">Proximity Lab is an award-winning interaction design studio with a 25-year track record providing product strategy, user</p>
      </div>
    </div>

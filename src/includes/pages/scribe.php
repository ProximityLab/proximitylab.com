...
<div id="description-2" class="container-fluid project-description">
  <div class="row">
    <div class="col-lg-6">
...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-12 d-flex justify-content-between ww-circle">
      <div></div>
      <div></div>
      <div></div>
    </div>
...
<div class="container-fluid halfie">
  <div id="code-support" class="row">
    ...
    <div class="col-md-6 d-flex flex-column justify-content-center text-container">

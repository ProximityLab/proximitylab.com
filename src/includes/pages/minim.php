...
<div class="container-fluid halfie">
    <div class="row">
      <div id="map" class="col-md-6 half-image flex-first"></div>
    ...
    <div class="row">
      <div id="bt" class="col-md-6 half-image"></div>
      <div class="col-md-6 d-flex flex-column justify-content-center flex-first text-container">
    ...
    <div class="row">
      <div id="moms" class="col-md-6 half-image flex-first"></div>
      <div class="col-md-6 d-flex flex-column justify-content-center flex-first text-container">

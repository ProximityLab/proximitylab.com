    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-lg-2">
              <img class="jumbotron-logo-project module-fade" src="/images/logo-adobe.svg" alt="Adobe logo">
            </div>
            <div class="col-12 col-sm-8 ww-hero-image module-fade"><img class="img-fluid" src="/images/website-mockup-adobe-2x.png" alt="Adobe mobile mockup"></div>

<div class="jumbotron jumbotron-fluid module-fade">
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-sm-8 ww-hero-image header-image-fade">
...
<div class="container-fluid 2 portfolio-header">
  <div class="row">
    <div class="col-12">
      ...
      <h1 class="heading-primary text-center module-fade">Super Simple Scheduling</h1>

      <p class="header-text text-center module-fade">Leveraging availability across platforms for streamline meetings</p>
    </div>
  </div>
</div>

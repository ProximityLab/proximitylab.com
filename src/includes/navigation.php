 ...
 <div class="primary-nav-holder">
	<nav class="page-navigation">
		...
		<ul class="d-flex">
			...
			<?php if ($isWorkCurrent) { ?><li class="align-self-center"><a href="?page=<?php echo $previous; ?>" class="jumbotron-left d-flex justify-content-center" alt="Previous project"><span class="align-self-center"></span></a></li><?php } ?>
			<?php if ($isWorkCurrent) { ?><li class="align-self-center"><a href="?page=<?php echo $next; ?>" class="jumbotron-right d-flex justify-content-center" alt="Next project"><span class="align-self-center"></span></a></li><?php } ?>
		</ul>
	</nav>
